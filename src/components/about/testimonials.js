        ...
        <div className='grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 xl:gap-[40px] gap-[20px]'>
          {testimonialData.map((testimonial) => (
            <div className='relative text-center bg-[#f9f9f9] hover:bg-[#f4f6fd] duration-500 hover:mt-[-15px] rounded-[30px] p-[30px] overflow-hidden group' key={testimonial.id}>
              ...
              <div className='inline-block overflow-hidden mb-[10px]'>
                <LazyLoad>
                  <img className='w-[70px] h-[70px] rounded-full object-center object-cover' src={testimonial.image} alt={testimonial.imageAlt} title="skypro about" />
                </LazyLoad>
              </div>
...
const testimonialData = [
  ...
  },
  {
    ...
    content: "We have been enjoying an exceptional IPTV service with our current provuder, and the experience has been nothing short of fantastic. The streaming quality is top-notch, delivering clear visuals and a seamless entertainment experience.",
    client: "Varun Antal",
  },
  {
    id: 3,
