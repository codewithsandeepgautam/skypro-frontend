      ...
      <div className="container">
        <div className='grid lg:grid-cols-2 items-center grid-cols-1 lg:gap-[50px] gap-[40px]'>
          <div className='about_vedio relative overflow-hidden xl:pt-[56%] pt-[56%]'>
            ...
            <iframe className='absolute top-0 left-0 w-full h-full object-cover object-center' src="https://www.youtube.com/embed/-c345tCaU8w?si=jRIVbDiksFdA9_V_" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </LazyLoad>
          </div>
