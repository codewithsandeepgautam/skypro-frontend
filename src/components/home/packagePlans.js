...
const PackagePlans = () => {
  return (
    <section className="relative overflow-hidden">
      <div className='absolute top-[-130px] w-[400px] z-[-1] left-0 max-sm:hidden'>
        <LazyLoad>
          <img
            src={ImageIcons.pricingBg}
            alt='Pricing'
          />
        </LazyLoad>
      </div>
              ...
              <div className='group bg-[#fbfbfb] hover:bg-[#071e43] hover:text-white duration-700 px-[30px] py-10'>
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <Link
                    to={data.links}
                    target="_blank"
                    className='text-[#fd5901] hover:bg-[#fd5901] hover:text-[#fff] w-[55px] bg-white h-[55px] flex justify-center items-center text-xl rounded-[50%] border-2 border-solid border-[#fadbdb]'
                    aria-label="Open in a new tab"
                  >
                    <LiaPlusSolid aria-hidden="true" />
                  </Link>
