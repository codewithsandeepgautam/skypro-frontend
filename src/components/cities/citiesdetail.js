                    ...
                    <div className='flex max-md:flex-col gap-[40px]'>
                        <div className='w-[68%] max-md:w-full'>
                            ...
                            <ul className='list_style'>
                                {serviceDetails?.otherinfo?.map((item, index) => {
                                    return (
                                        <div key={index}>
                                            <li>
                                                {item?.listing}
                        ...
                        <div className='w-[32%] max-md:w-full sticky top-[110px] py-[40px] h-full text-white px-[30px] bg-[linear-gradient(157deg,#061e43_0%,#3ad8ff_100%)] rounded-[22px]'>
                            ...
                            <Link to='https://play.google.com/store/apps/details?id=com.onnet.skypro' target='_blank' className="flex mt-6 w-48 h-14 bg-white text-black rounded-lg items-center justify-center">
                                <div className="mr-3">
