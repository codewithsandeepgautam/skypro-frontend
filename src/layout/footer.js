      ...
      <footer className="bg-primary text-white">
        <div className="container">
          <div className="grid lg:grid-cols-4 sm:grid-cols-2 xl:gap-[50px] gap-[40px] py-[50px]">
            ...
            <div className="">
                <Link className="footer-img" to="/home" onClick={windowScroll}>
              <LazyLoad>
                  <img
        ...
        <div className="py-[25px] text-white border-t border-[#ffffff21]">
          <div className="container">
            <div className="grid md:grid-cols-2 grid-cols-1 gap-[15px] justify-between items-center max-md:text-center">
              ...
              <p className="md:text-right mb-0">Powered by Digitax India Communications Private Limited</p>
            </div>
          </div>
        </div>
      </footer>
      <button
        className={`group flex justify-center items-center md:right-[30px] duration-500 right-[15px] bg-[#329bbd] hover:bg-[#061e43] w-[50px] h-[50px] shadow-md shadow-[#ffffff75] rounded-full z-50 ${showButton ? 'opacity-100 overflow-visible fixed transition-[0.8s] bottom-[60px]' : 'bottom-[102%]'}`}
        onClick={scrollToTop}
...
const footerRightLink = [
  ...
  {
    url: "/privacy-policy-kr",
    content: "Privacy Policy Kr",
  },
  {
