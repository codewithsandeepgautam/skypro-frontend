...
const Iptv = () => {
  return (
    <>
      <SEO title="IPTV App for Android & Smart TV | Live TV & IPTV Channels"
        description="Stream live TV with the IPTV app for Android and Smart TVs. Access IPTV channels, download the app, and enjoy a variety of IPTV streaming options."
        keywords=' IPTV app, Best IPTV app, IPTV streaming app, IPTV player app, Free IPTV app, IPTV app for Android, IPTV app for Smart TV, IPTV subscription app, Live, TV app, Internet TV app, IPTV app download, IPTV app channels' />
        ...
        <div className='container'>
          ...
          <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:gap-[30px] gap-[20px]'>
            ...
            <div className='group relative z-20 shadow-[0px_3px_15px_0px_rgba(0,0,0,0.1)] p-[30px] rounded-[10px]  after:absolute after:content-[""] after:-z-10 after:w-full after:h-full after:hover:bg-[#fd5901] after:rounded-[10px] after:origin-left after:opacity-0 after:invisible after:scale-y-0 after:right-0 after:top-0 after:duration-700 after:hover:opacity-100 after:hover:visible after:hover:scale-y-100 hover:text-white'>
              ...
              <p>
                With Skypro’s <Link
                  to="https//www.skypro.co.in/subscription-packages-iptv"
      ...
      <section>
        <div className='container !max-w-[1200px]'>
          ...
          <div className='relative overflow-hidden xl:pt-[56%] pt-[56%]'>
            <iframe className='absolute top-0 left-0 w-full h-full object-cover object-center' src="https://www.youtube.com/embed/L7eERRW_VBI?si=athoIWva-G4VVAAj" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
          </div>
