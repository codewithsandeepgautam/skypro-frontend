      ...
      <section>
        <ul className='list-none m-0 p-0'>
          <li className='relative pl-[20px] pb-[5px]'>
            <Link onClick={windowScroll} to="/home" className='inline-block py-[5px]'>Home</Link>
            <ul className='list-none m-0 p-0'>
...
const navigationData = [
  ...
  {
    title: "Packages",
    link: "/subscription-packages-iptv",
    subMenu: [
      {
        label: "FTA Channels",
  ...
  // },
  {
    ...
    subMenu: [
      ...
      ,
      {
        label: "IPTV Service Providers- Today’s Premier Choice for Broadcasting?",
        link: "/blogs/iptv-service-providers-premier-choice-broadcasting",
      }
    ]
  },
  {
