...
const ContactUs = () => {
  ...
  const PackageInfo = params?.state?.item
  const { packageData, setPackageData } = useContext(AccountContext);
  ...
  return (
    <>
      ...
      />
      <InnerPageBanner title='Contact Us' innerPageBanner={ImageIcons.contactBg2} />
      <section className="">
              ...
              <div className="grid md:grid-cols-2 gap-[20px]" id="contactusForm">
                ...
                <div>
                  ...
                  <input
                    ...
                    disabled={PackageInfo ? true : false}
                  />
                </div>
